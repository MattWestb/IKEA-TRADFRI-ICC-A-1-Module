...
[Tasmota](Tasmota) have fixing the ZB3 network problems and moving from alphstage to more stabile beta for testing.
...
Zigpy have getting v8 support and also some Zigbee2Mqtt fans are trying implenting EZSP in Z2M.  
